...
export class APIClient extends Core {
    ...
    private actions = {
        createTask : (i: CreateTaskInput) => {
            return this.client.rawRequest<Task>("createTask", i);
        },
        getTask : (i: GetTaskInput) => {
            return this.client.rawRequest<Task | null>("getTask", i);
        },
        updateTask : (i: UpdateTaskInput) => {
            return this.client.rawRequest<Task>("updateTask", i);
        },
        deleteTask : (i: DeleteTaskInput) => {
            return this.client.rawRequest<string>("deleteTask", i);
        },
        listTask : (i?: ListTaskInput) => {
            return this.client.rawRequest<{results: Task[], pageInfo: any}>("listTask", i);
        },
    ...
    api = {
        queries: {
            getTask: this.actions.getTask,
            listTask: this.actions.listTask,
        },
        mutations: {
            createTask: this.actions.createTask,
            updateTask: this.actions.updateTask,
            deleteTask: this.actions.deleteTask,
...
export interface UpdateTaskWhere {
    id: string;
}
...
export interface UpdateTaskInput {
    where: UpdateTaskWhere;
    values: UpdateTaskValues;
}
export interface DeleteTaskInput {
    id: string;
}
export interface ListTaskWhere {
}
